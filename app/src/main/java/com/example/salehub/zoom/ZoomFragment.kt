...
import com.example.salehub.databinding.FragmentZoomBinding

class ZoomFragment : BaseViewBindingFragment<FragmentZoomBinding>() {
    override fun inflateViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?,
        attachToParent: Boolean
    ): FragmentZoomBinding? {
        return FragmentZoomBinding.inflate(inflater, container, false)
    }
    ...
    override fun initView() {
        binding?.thumbButton1?.setOnClickListener {
            zoomImageFromThumb(binding!!.thumbButton1, R.drawable.dog)
        }
